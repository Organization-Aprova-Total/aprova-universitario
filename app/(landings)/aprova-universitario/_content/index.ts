...
export const conteudo = {
  ...
  disciplinas: {
    ...
    itens: [
      { foto: "anatomia", nome: "Anatomia", p: "Estude a estrutura do corpo humano de forma integrada e visual. Ideal para quem precisa visualizar para entender." },
      { foto: "bioquimica", nome: "Bioquímica", p: "Aprenda como as reações bioquímicas transformam os nutrientes em energia e compreenda os principais ciclos, enzimas e processos metabólicos do organismo." },
      { foto: "fisiologia", nome: "Fisiologia", p: "Veja como o corpo funciona de verdade. Entenda os principais mecanismos dos sistemas (nervoso, cardiovascular, respiratório etc.) com esquemas e explicações claras." },
      { foto: "histologia", nome: "Histologia", p: "Aprenda a identificar os tecidos do corpo em nível microscópico. Entenda como as células se organizam para formar os tecidos que compõem os órgãos e como essa organização se relaciona com as funções fisiológicas." },
      { foto: "patologia", nome: "Patologia", p: "Veja o que pode acontecer quando algo dá errado no corpo. Foco em inflamações, lesões, necroses e adaptações celulares, sempre com relação à prática clínica." },
      { foto: "microbiologia", nome: "Microbiologia", p: "Entenda as principais características de vírus, bactérias e fungos e compreenda como esses agentes infecciosos atuam no organismo e impactam sua saúde." },
      { foto: "imunologia", nome: "Imunologia", p: "Aprenda como funciona o sistema imunológico e saiba identificar os diferentes tipos de imunidade que protegem o nosso corpo." },
      { foto: "genetica", nome: "Genética", p: "Genética vai muito além do DNA. Entenda como variações no nosso genótipo podem impactar o funcionamento do organismo." },
      { foto: "parasitologia", nome: "Parasitologia", p: "Estude os principais parasitas que afetam os seres humanos e as doenças que eles causam. Aprenda a reconhecer, prevenir e compreender as infecções parasitárias mais comuns." },
      { foto: "farmacologia", nome: "Farmacologia", p: "Entenda como os medicamentos agem no corpo, explorando os princípios de farmacocinética, farmacodinâmica e os possíveis efeitos adversos das diferentes classes farmacológicas." },
      { foto: "embriologia", nome: "Embriologia", p: "Entenda o desenvolvimento humano desde a gametogênese até a formação dos sistemas orgânicos." },
    ],
  },
